...
#Updated for MP BLock C: LAB 12.12.2018

#set the working directory
setwd("E:/MP/WithBlockC/HM_BlockC")
...
DRCcon <- dbConnect(pgSQL, host='daacsrc.org', port='5432',
...
csrX <- dbGetQuery(DRCcon,' 
                  SELECT  
                  a."ProjectID",
                  a."Context" as "context",
                  a."DAACSStratigraphicGroup" as "SG",
                  a."DAACSStratigraphicGroup" as "SG",
a."MasterContextNumber",
                  a."FeatureNumber",
                ...
                WHERE (a."ProjectID" = \'1243\') 
                  ORDER BY a."Context"
                  ')

csr <- subset(csrX, csrX$MasterContextNumber  %in%  c('BlockC'))
